...
export default function AddDriverPage({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      await driverService.create({ name: name.trim(), phone: phone.trim(), status });
        ...
        <div className="mx-auto max-w-2xl px-4 py-5 sm:px-6">
          ...
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[var(--color-action-primary)]/10">
              <UserPlus className="h-5 w-5 text-[var(--color-action-primary)]" />
            </div>
        ...
        >
          ...
          <div className="mt-8 flex gap-3">
            ...
            >
              ...
              {submitting ? t("saving") : t("saveDriver")}
            </button>
          </div>
        </form>
      </div>
